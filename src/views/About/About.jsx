    ...
    <div className={styles.colores}> 
        ...
        <section className={styles.headercontainer}>
            ...
            <div className={styles.sideleft}>
                ...
                <p>Enjoy our products and travel with the palate to any part of the planet, in each section of the page you will find details of the products that interest you as well as ease in obtaining them. .</p>
            </div>
            ...
            <img className={styles.imagen} src={vino2} alt="girl" />
                ...
                <div className={styles.text}>
                    ...
                    <p>We are a company with a belief which is that it is not necessary to be in a place to know it if you can travel with only a sip of our products..</p>
